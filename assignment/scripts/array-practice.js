...
let favoriteFoods= ['steak tacos',  'pizza',  'burger',  'carrot cake'];
...
console.log('Added a food item to the end, ', favoriteFoods);
...
console.log('The list of foods are', favoriteFoods); 
// Example: Add an animal to the beginning using Array.unshift
animalArray.unshift('walrus');
console.log(`Added an animal to beginning: ${animalArray}`);

// 4.c. TODO: Add a food at the beginning of the array & log the array
favoriteFoods.unshift('cookies');
console.log(`Added a food item to begginning: ${favoriteFoods}`);
...
console.log('The list of foods are now', favoriteFoods);
// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
let newFood= favoriteFoods[1]='burritos'; 
console.log('Replaced the second food item with', newFood);
...
var newstring= favoriteFoods.join(' and ' );
